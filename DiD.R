...
didreg2018 = lm(num_children_own ~ eligible + time + did + age_w + married + nat_country, data = DiD_data_2018)
summary(didreg2018)


DiD_data_2019 <- rbind(preprocessed_DiD_data(2017,6), preprocessed_DiD_data(2019,1))

DiD_data_2019$time = (DiD_data_2018$year == 2017)
DiD_data_2019$did = DiD_data_2019$time * DiD_data_2019$eligible


didreg2019 = lm(num_children_own ~ eligible + time + did + age_w + married + nat_country, data = DiD_data_2019)
summary(didreg2019)
